...
public class TMState extends State {
    ...
    public TMState(TMState copyMe) { //do we really need a pointer to the parent?
        ...
        myInnerTuringMachine = (TuringMachineBuildingBlocks) copyMe.getInnerTM()
            .clone(); //this should output in recursion until we reach a TMState whose inner TM does not contain states.
    }
    ...
    public String getInternalName() { //just for trying to preserve old way of saving.
        ...
        return myInternalName == null ? myInternalName = "Machine" + getID() :
