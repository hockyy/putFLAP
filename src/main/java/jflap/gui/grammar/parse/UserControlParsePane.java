...
public class UserControlParsePane extends BruteParsePane {
    ...
    private void intializeGrammarTableSetting() {
        ...
        grammarTable.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                stepAction.setEnabled(mySelectedProductionIndex > -1 &&
    ...
    public boolean step() {
        ...
        if (count > 0) {
            if (count > 1) {
                ...
                if (myStringJList.getSelectedIndex() < 0) {
                    ...
                    for (int i = 0; i < length; i++) {
                        temp =
                            temp + myJListModel.getElementAt(myStringJList.getSelectedIndex() + i);
                    }
            ...
            JOptionPane
                .showMessageDialog(this, "Previous Derivation does not support this Production",
                    "Bad Input",
                    JOptionPane.ERROR_MESSAGE);
            stepAction.setEnabled(false);
            return false;
