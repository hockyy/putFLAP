...
public class AddTrapStateController {
     ...
     */
    public AddTrapStateController(FiniteStateAutomaton automaton, SelectionDrawer drawer,
                                  JLabel mainStep, JLabel detailStep,
                                  JFrame frame) {
    ...
    private void nextStep() {
        switch (currentStep) {
            ...
            case TRANSITIONS_TO_TRAPSTATE:
                ...
                detailStep
                    .setText("Put transitions from all states to the trap state.   " + remaining +
