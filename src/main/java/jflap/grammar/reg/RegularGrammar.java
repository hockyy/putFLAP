...
public class RegularGrammar extends Grammar {
     ...
     *
     * @param linearity the linearity of the jflap.grammar.
     */
     ...
     * @throws IllegalArgumentException if the production is in some way illegal for the jflap.grammar
     */
     ...
     *
     * @throws IllegalArgumentException if this production is somehow illegal for this jflap.grammar (i.e.,
