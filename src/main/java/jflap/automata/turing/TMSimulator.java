...
//                }
     ...
     */
    public ArrayList<Configuration> stepConfiguration(
...
//        System.out.println(config);
        ...
        TMState currentState = (TMState) configuration
        ...
        while (true) {
            ...
            Arrays.sort(trans, new Comparator<Transition>() {
                public int compare(Transition a,
...
//                    System.out.println(tmt);
                ...
                null) //if this fails, that means that you forgot to set the parent in the XML encoder
            {
                ...
                trans =
                    tmp.getTransitionsFromState(currentState); //this line does not matter right now
            } else {
