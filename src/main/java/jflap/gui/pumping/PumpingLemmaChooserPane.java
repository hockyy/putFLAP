...
public class PumpingLemmaChooserPane extends JPanel {
    ...
    private JPanel initRadioButtonPanel() {
        ...
        buttonPanel
            .setBorder(BorderFactory.createTitledBorder("First choose who makes the first move."));
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (humanButton.isSelected()) {
                        if (myLemma instanceof RegularPumpingLemma) {
                            ...
                            pane =
                                new HumanCFPumpingLemmaInputPane((ContextFreePumpingLemma) myLemma);
                        }
                        ...
                        if (myLemma instanceof RegularPumpingLemma) {
                            ...
                            pane =
                                new CompCFPumpingLemmaInputPane((ContextFreePumpingLemma) myLemma);
                        }
                    }
