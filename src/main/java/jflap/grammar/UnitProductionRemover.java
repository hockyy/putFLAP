...
public class UnitProductionRemover {
     ...
     *
     * @param oldGrammar a jflap.grammar
     * @param newGrammar a jflap.grammar
     */
     ...
     *
     * @param oldGrammar the original jflap.grammar
     * @param newGrammar the new jflap.grammar
     * @param graph      the variable dependency graph of the original jflap.grammar
     */
     ...
     *
     * @param grammar the jflap.grammar
     * @param graph   the variable dependency graph of <CODE>jflap.grammar</CODE>.
