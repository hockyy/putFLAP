        ...
        myDecompButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                ...
                if (myLemma.isInLang(myLemma.createPumpedString())) {
                    myLemma.addAttempt(
                        myLemma.getDecompositionAsString() + "; I = " + myLemma.getI() +
                            "; <i>Won</i>");
                } else {
                    myLemma.addAttempt(
                        myLemma.getDecompositionAsString() + "; I = " + myLemma.getI() +
