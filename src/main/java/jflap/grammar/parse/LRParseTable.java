...
public class LRParseTable extends AbstractTableModel implements Serializable,
     ...
     *
     * @param grammar the augmented jflap.grammar
     * @param fsa     the goto graph for the jflap.grammar
     */
     ...
     * @param symbol the jflap.grammar symbol
     * @throws IllegalArgumentException if symbol is not in the jflap.grammar
     */
     ...
     *
     * @param value  the value that was read into the table
     ...
     *
     * @param input the read in the table
     */
