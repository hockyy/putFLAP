...
public class TMBBTransducer extends AutomatonTransducer {
    ...
    protected Transition createTransition(State from, State to, Node node,
        ...
        int tapes = tm.tapes();
        String[] readStrings = new String[tapes], writeStrings = new String[tapes], moveStrings =
            new String[tapes];
    ...
    protected Element createTransitionElement(Document document,
        ...
        TuringMachineBuildingBlocks tm =
            (TuringMachineBuildingBlocks) t.getFromState().getAutomaton();
