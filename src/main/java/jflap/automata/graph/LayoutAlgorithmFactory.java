...
public class LayoutAlgorithmFactory {
     ...
     * @return A random <code>LayoutAlgorithm</code> among those defined.
     */
    public static LayoutAlgorithm getRandomLayoutAlgorithm(Dimension pSize, Dimension vDim,
                                                           double vBuffer) {
        Random random = new Random();
     ...
     * @return A layout algorithm corresponding to the <code>algorithm</code> value.
     */
    public static LayoutAlgorithm getLayoutAlgorithm(int algorithm, Dimension pSize, Dimension vDim,
                                                     double vBuffer) {
        switch (algorithm) {
            case RANDOM_CHOICE:
