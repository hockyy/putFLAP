...
public class InputTableModel extends GrowableTableModel {
     ...
     * This instantiates an <CODE>InputTableModel</CODE>.
     *
     * @param columns the number of columns for this read table model
     */
     ...
     * null)</CODE>.
     *
     * @param row    the row to set the output of
     * @param result the output to put in the output column
    ...
    public void setResult(int row, String result, Configuration config,
                          ArrayList<String> comparison, int index) {
        ...
        if (config instanceof TMConfiguration && config != null) {
            ...
            if (config.isAccept()) {
                for (int i = 0; i < tapes.length; i++) {
                    ...
                    if (comparison != null) {
                        ...
                        if (comparison.get(index + outNum).toLowerCase()
                            .startsWith("r")) {
                            if (!result.endsWith(")")) {
            ...
            if (comparison != null && (index + outNum) < comparison.size()) {
                if (comparison.get(index + outNum).toLowerCase().startsWith("r") &&
                    ...
                    !comparison.get(index + outNum).toLowerCase().startsWith("r") &&
                        !accept) {
                    if (!result.endsWith(")")) {
                        result = result + "(Accept)";
                    }
