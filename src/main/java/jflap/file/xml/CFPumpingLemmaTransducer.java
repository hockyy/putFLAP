...
public class CFPumpingLemmaTransducer extends PumpingLemmaTransducer {
    ...
    public Serializable fromDOM(Document document) {
        ContextFreePumpingLemma pl =
            (ContextFreePumpingLemma) PumpingLemmaFactory.createPumpingLemma
        ...
        int uLength =
            Integer.parseInt(document.getElementsByTagName(U_NAME).item(0).getTextContent());
        int vLength =
            Integer.parseInt(document.getElementsByTagName(V_NAME).item(0).getTextContent());
        int xLength =
