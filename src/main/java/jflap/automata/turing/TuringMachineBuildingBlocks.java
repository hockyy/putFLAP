...
public class TuringMachineBuildingBlocks extends TuringMachine {
    ...
    public static void become(TuringMachineBuildingBlocks dest, TuringMachineBuildingBlocks src) {
        ...
        HashMap<TMState, TMState> map =
            new HashMap<TMState, TMState>(); // Old states to new states.
...
//			copyStaticRelevantDataForBlocks(nstate, state, dest, src);
        ...
        dest.setInitialState(map.get((TMState) src.getInitialState()));
...
//            System.out.println(o.getClass().getName());
        ...
        a.setInitialState(map.get((TMState) getInitialState()));
...
//				this);
    ...
    public Map<String, TuringMachineBuildingBlocks> getTMBBBlockMap() {
        Map<String, TuringMachineBuildingBlocks> ret =
            new HashMap<String, TuringMachineBuildingBlocks>();
    ...
    public void setParent(TMState tms) {
        ...
        //not going to force it with compiler, just make sure you set it WHERE it MATTERS
}
