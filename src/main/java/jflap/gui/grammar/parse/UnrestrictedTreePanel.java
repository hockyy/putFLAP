...
public class UnrestrictedTreePanel extends TreePanel {
     ...
     *
     * @param answer the end output of a parse tree derivation, or <CODE>null</CODE>
     ...
     * @param point  the point to store the output in
     */
    ...
    private void paintTree(Graphics2D g) {
        ...
        while (it.hasNext()) {
            Map.Entry<UnrestrictedTreeNode, Point2D> e =
                it.next();
