...
public class LSystem implements Serializable {
     ...
     *
     * @param replacements the jflap.grammar holding the replacement rules, where each
     ...
     *
     * @param replacements the jflap.grammar holding the replacement rules
     */
    private void initReplacements(Grammar replacements) {
        ...
        while (it.hasNext()) {
            Map.Entry<String, ArrayList<List<String>>> entry =
                it.next();
