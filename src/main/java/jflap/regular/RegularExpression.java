...
public class RegularExpression implements Serializable {
     ...
     *
     * @param string the string to treat as a jflap.regular expression
     */
     ...
     *
     * @param string the string to change the jflap.regular expression to
     */
     ...
     *
     * @param ref the reference to a string to change the jflap.regular expression to
     */
     ...
     *
     * @param old the old string representation of the jflap.regular expression
     */
