...
abstract class ParsePane extends JPanel {
    ...
    protected void initView() {
        ...
        if (pt != null) {
            topHolder
                .add(new TableTextSizeSlider((JTable) pt, JSlider.HORIZONTAL), BorderLayout.NORTH);
        }
...
//		Object[] columns = {"Titles", "Fields"};
        ...
        bigger.add(new TripleTextFieldSizeSlider(inputField, inputDisplay, stackDisplay,
                JSlider.HORIZONTAL, "Input Field Text Size "
                +
                "(For optimization, move one of the window size adjustors around this window after resizing the text fields)"),
            BorderLayout.SOUTH);
