...
public class FSAToREController {
    ...
    protected void nextStep() {
        switch (currentStep) {
            ...
            case TRANSITIONS_TO_SINGLE_FINAL:
                detailStep
                    .setText("Put " + Universe.curProfile.getEmptyString() +
    ...
    public Transition transitionCreate(State from, State to) {
        ...
        if (currentStep == CREATE_EMPTY_TRANSITIONS) {
            ...
            Transition t =
                FSAToRegularExpressionConverter.addTransitionOnEmptySet(from, to, automaton);
            remaining--;
            nextStep();
            frame.repaint();
            return t;
    ...
    public boolean stateCollapse(State state) {
        ...
        transitionWindow
            .setTransitions(FSAToRegularExpressionConverter.getTransitionsForRemoveState(
                state, automaton));
    ...
    public void finalizeStateRemove() {
        ...
        FSAToRegularExpressionConverter
            .removeState(collapseState, transitionWindow.getTransitions(),
                automaton);
        remaining--;
        nextStep();
        collapseState = null;
        ...
        switch (currentStep) {
            ...
            case COLLAPSE_STATES:
                ...
                for (int i = 0; i < s.length; i++) {
                    ...
                    Transition[] t =
                        FSAToRegularExpressionConverter.getTransitionsForRemoveState(s[i],
                            automaton);
