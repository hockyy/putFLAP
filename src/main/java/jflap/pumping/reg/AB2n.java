...
public class AB2n extends RegularPumpingLemma {
    ...
    public void setDescription() {
        ...
        explanation =
            "Because this is a jflap.regular language, a valid decomposition exists.  As long as <i>m</i> " +
                GREATER_OR_EQ +
                " 4, then if <i>y</i> = \"abab\" (or \"baba\" if <i>m</i>" + GREATER_OR_EQ +
    ...
    public boolean isInLang(String s) {
        ...
        return n > 0 && n % 2 == 0 && temp.length() == 0;
    }
}
